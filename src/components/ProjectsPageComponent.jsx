...
export default function ProjectsPageComponent() {
  ...
  return (
    <ScreenContainerComponent className="ProjectsPageComponent" title="Winston Sosa Portfolio - Projects">
      <ToolbarComponent />
      <main className={"p-4 md:p-8 lg:p-8 xl:p-8"}>
        ...
        <div className={"grid grid-cols-1 place-items-start gap-2 md:flex md:flex-start md:justify-start lg:flex lg:flex-start lg:justify-start"}>
          ...
          <p style={{ color: filterType === ANDROID_FILTER_TYPE ? "white" : "black" }} onClick={() => setFilterType(ANDROID_FILTER_TYPE)} className={"ItemFilter mr-5 " + (filterType === ANDROID_FILTER_TYPE ? "bg-blue-500 text-white hover:bg-blue-700 hover:text-white font-bold py-2 px-4 rounded-full" : "text-black py-2 px-4")}>Mobile Apps</p>
